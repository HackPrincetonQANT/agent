...
var downloadImage = async (url, options = {}) => {
  ...
  for (let attempt = 0; attempt <= maxRetries; attempt++) {
    try {
      ...
      const path = join(TEMP_DIR2, `imsg_temp_${Date.now()}${ext}`);
...
export { ConfigError, DatabaseError, IMessageError, IMessageSDK, MessageChain, PlatformError, SendError, WebhookError, asRecipient, definePlugin, isMacOS, loggerPlugin, requireMacOS };
